...
class Network(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_L3 = nn.Sequential(
            nn.Conv2d(in_channels=self.nb_kernels_c1, out_channels=self.nb_kernels_c2, kernel_size=self.kernel_size_c2, stride=1, padding=0),
        ...
        self.conv_L5 = nn.Sequential(nn.Conv2d(in_channels=self.nb_kernels_c2, out_channels=self.nb_kernels_c3, kernel_size=self.kernel_size_c3, stride=1, padding=0),
            nn.LeakyReLU(),
        ...
        self.conv_L7 = nn.Sequential(
            nn.Conv2d(in_channels=self.nb_kernels_c3, out_channels=self.nb_kernels_c4, kernel_size=self.kernel_size_c4, stride=1, padding=0),
        ...
        self.conv_L9 = nn.Sequential(
            nn.Conv2d(in_channels=self.nb_kernels_c4, out_channels=self.nb_kernels_c5, kernel_size=self.kernel_size_c5, stride=1, padding=0),
